...
CREATE TABLE `book` (
  ...
  `pulication_place` varchar(50) NOT NULL,
  `authors` int NOT NULL,
  `status` tinyint NOT NULL,
  `category_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `_idx` (`category_id`),
  KEY `author_idx` (`authors`),
  CONSTRAINT `authors` FOREIGN KEY (`authors`) REFERENCES `authors` (`id`),
...
CREATE TABLE `library_card` (
  ...
  `acount_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `account_id_idx` (`acount_id`),
  CONSTRAINT `account_id` FOREIGN KEY (`acount_id`) REFERENCES `account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-04-05 15:28:57
